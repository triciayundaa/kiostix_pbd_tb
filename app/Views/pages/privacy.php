...
<head>
    ...
    <title>Kebijakan Privasi - KiosTix</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="terms-content">
            <p>KiosTix sangat menghargai privasi Anda. Kebijakan ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi pribadi Anda saat menggunakan layanan kami.</p>
            <ol>
                <li>Informasi yang kami kumpulkan meliputi nama, alamat email, nomor telepon, dan data transaksi yang Anda berikan saat mendaftar atau membeli tiket.</li>
                <li>Data pribadi Anda digunakan untuk memproses pesanan, mengirimkan tiket elektronik, dan memberikan informasi terkait acara yang Anda beli.</li>
                <li>Kami tidak akan menjual atau menyewakan informasi pribadi Anda kepada pihak ketiga untuk tujuan pemasaran tanpa persetujuan eksplisit dari Anda.</li>
                <li>KiosTix menggunakan langkah-langkah keamanan berstandar industri untuk melindungi data Anda dari akses yang tidak sah atau kebocoran data.</li>
                <li>Anda berhak untuk mengakses, memperbarui, atau menghapus informasi pribadi Anda dari sistem kami dengan menghubungi layanan pelanggan.</li>
            </ol>
            <p>Dengan menggunakan situs web kami, Anda dianggap telah membaca dan menyetujui Kebijakan Privasi ini. Kebijakan ini dapat diperbarui sewaktu-waktu sesuai dengan perubahan layanan atau peraturan yang berlaku.</p>
        </div>
