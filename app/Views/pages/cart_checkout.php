...
<head>
    ...
    <title>Checkout Keranjang - KiosTix</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .item-row { display: flex; justify-content: space-between; font-size: 13px; color: #555; margin-bottom: 10px; align-items: center;}
        .item-row .item-title { flex: 1; margin-right: 15px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;}
        .item-row .item-price { font-weight: 600; white-space: nowrap;}
...
<body>
    ...
    <form action="<?= base_url('cart/process-payment') ?>" method="POST" id="paymentForm">
        <?= csrf_field() ?>
        ...
        <div class="container">
            ...
            <div class="right-column">
                ...
                <div style="margin-bottom: 20px;">
                    <div class="summary-row bold" style="margin-bottom: 15px;">Item Keranjang:</div>
                    <?php foreach($cartItems as $item): ?>
                        <div class="item-row">
                            <div class="item-title"><?= esc($item['title']) ?> (<?= esc($item['quantity']) ?>)</div>
                ...
                <div class="grand-total-row">
                    ...
                    <div class="grand-total-value">Rp.<?= number_format($subTotal + 3000, 0, ',', '.') ?></div>
                </div>
    ...
    <script>
        ...
        const timerInterval = setInterval(() => {
            ...
            if(timeInSeconds <= 0) {
                ...
                alert('Waktu pembayaran habis. Anda akan diarahkan kembali ke keranjang.');
